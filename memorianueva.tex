...
En la presente memoria se aborda el diseño e implementación de un prototipo que permite la captura automatizada de imágenes y la contabilización de los frutos en una plantación. Este trabajo se realizó como parte de un proyecto de investigación que contribuye a la planificación y ejecución de la cosecha por parte del productor. Para su desarrollo, fueron fundamentales los conocimientos adquiridos en la carrera, tales como conceptos de visión por computadora, testing de software, inteligencia artificial y programación de microcontroladores.
\end{abstract}
...
\dedicatory{\textbf{Dedico este trabajo a mis seres queridos, quienes me han impulsado a continuar mis estudios en cada etapa de mi vida.}}
